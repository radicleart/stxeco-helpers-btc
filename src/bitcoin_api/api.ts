...
export async function fetchCurrentFeeRates(mempoolUrl:string, blockCypherUrl:string, network:string) {
  try {
    if (network === 'devnet') {
...
export async function sendRawTxDirectBlockCypher(blockCypherUrl:string, hex:string) {
...
export async function fetchAddressTransactions(mempoolUrl:string, address:string, txId?:string) {
  ...
  export async function fetchAddressTransactionsMin(mempoolUrl:string, address:string) {
  ...
  export async function fetchUtxosForAddress(electrumUrl:string, address:string) {
